...
# Load sounds
from left_sound_thread import Left_sound
from right_sound_thread import Right_sound
from sound_test import Sound_mask
...
# 眨眼的帧数,
blinking_frames = 0
# 当 blinking_frames == frames_to_blink 时,表示选中
frames_to_blink = 6
            ...
            if blinking_ratio > 5:
                ...
                if blinking_frames == frames_to_blink:
                    ...
                    if active_letter == "_":
                        text += " "
                    # sound.play()
                    # thread1 = Sound_thread("sound.wav")
                    # # 开启新线程
                    # thread1.start()
                    select_keyboard_menu = True
                    # time.sleep(1)
